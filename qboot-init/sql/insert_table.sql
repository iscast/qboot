...
INSERT INTO `sys_menu` (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, TYPE, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS)VALUES (17, '2', '0,1,2', '查询用户', 1, NULL, NULL, '999', NULL, '1', 'sys:user:qry', 'system' ,now(), 'system', now(), NULL);
...
INSERT INTO `sys_menu` (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, TYPE, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS)VALUES (19, '2', '0,1,2', '删除', 2, '', '', '999', NULL, '1', 'sys:user:delete', 'system', now(), 'system', now(), NULL);
INSERT INTO `sys_menu` (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, TYPE, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS)VALUES (20, '2', '0,1,2', '添加', 3, '', NULL, '999', '', '1', 'sys:user:save', 'system', now(), 'system', now(), NULL);
...
INSERT INTO `sys_menu` (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, TYPE, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS)VALUES (25, '4', '0,1,4', '查询菜单', 1, NULL, '', '999', NULL, '1', 'sys:menu:qry', 'system', now(), 'system', now(), '');
...
INSERT INTO `sys_menu` (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, TYPE, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS)VALUES (29, '5', '0,1,5', '查询部门', 1, NULL, '', '999', NULL, '0', 'sys:dept:qry', 'system', now(), 'system', now(), '');
...
INSERT INTO `sys_menu` (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, TYPE, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS)VALUES (41, '8', '0,1,8', '新增', 10, NULL, NULL, '999', '', '1', 'sys:task:save', 'system', now(), 'system', now(), NULL);
INSERT INTO `sys_menu` (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, TYPE, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS)VALUES (42, '8', '0,1,8', '删除', 10, NULL, NULL, '999', '', '1', 'sys:task:delete', 'system', now(), 'system', now(), NULL);
INSERT INTO `sys_menu` (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, TYPE, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS)VALUES (43, '8', '0,1,8', '查询', 1, NULL, NULL, '999', '', '1', 'sys:task:qry', 'system', now(), 'system', now(), NULL);
INSERT INTO `sys_menu` (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, TYPE, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS)VALUES (44, '9', '0,1,9,', '查询', 1, NULL, NULL, '999', NULL, '1', 'sys:gen:qry', 'system', now(), 'system', now(), NULL);
INSERT INTO `sys_menu` (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, TYPE, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS)VALUES (45, '9', '0,1,9,', '修改', 2, NULL, NULL, '999', NULL, '1', 'sys:gen:update', 'system', now(), 'system', now(), NULL);
INSERT INTO `sys_menu` (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, TYPE, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS)VALUES (46, '9', '0,1,9,', '删除', 3, NULL, NULL, '999', NULL, '1', 'sys:gen:delete', 'system', now(), 'system', now(), NULL);
INSERT INTO `sys_menu` (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, TYPE, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS)VALUES (47, '9', '0,1,9,', '添加', 4, NULL, NULL, '999', NULL, '1', 'sys:gen:save', 'system', now(), 'system', now(), NULL);
INSERT INTO `sys_menu` (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, TYPE, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS)VALUES (48, '11', '0,10,11', '查询', 1, NULL, NULL, '999', NULL, '0', 'sys:loginlog:qry', 'system', now(), 'system', now(), '');
INSERT INTO `sys_menu` (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, TYPE, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS)VALUES (49, '11', '0,10,11', '删除', 2, NULL, NULL, '999', NULL, '0', 'sys:loginlog:delete', 'system', now(), 'system', now(), NULL);
INSERT INTO `sys_menu` (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, TYPE, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS)VALUES (50, '13', '0,10,13', '查询', 1, NULL, '', '999', 'layui-icon-search', '1', 'sys:operatelog:qry', 'system', now(), 'system', now(), '');
INSERT INTO `sys_menu` (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, TYPE, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS)VALUES (51, '12', '0,10,12', '查询', 2, NULL, '', '999', 'layui-icon-search', '1', 'sys:operateinfo:qry', 'system', now(), 'system', now(), '');
INSERT INTO `sys_menu` (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, TYPE, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS)VALUES (52, '12', '0,10,12', '添加', 1, NULL, '', '999', NULL, '1', 'sys:operateinfo:save', 'system', now(), 'system', now(), '');
INSERT INTO `sys_menu` (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, TYPE, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS)VALUES (53, '12', '0,10,12', '修改', 2, NULL, '', '999', NULL, '1', 'sys:operateinfo:update', 'system', now(), 'system', now(), '');
INSERT INTO `sys_menu` (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, TYPE, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS)VALUES (54, '12', '0,10,12', '删除', 3, NULL, '', '999', NULL, '1', 'sys:operateinfo:delete', 'system', now(), 'system', now(), '');
COMMIT;
