...
INSERT INTO `sys_menu` (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, TYPE, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS)VALUES (53, '12', '0,10,12', '查询', 2, NULL, '', '999', 'layui-icon-search', '1', 'sys:operateinfo:qry', 'system', now(), 'system', now(), '');
INSERT INTO `sys_menu` (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, TYPE, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS)VALUES (54, '12', '0,10,12', '添加', 1, NULL, '', '999', NULL, '1', 'sys:operateinfo:save', 'system', now(), 'system', now(), '');
INSERT INTO `sys_menu` (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, TYPE, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS)VALUES (55, '12', '0,10,12', '修改', 2, NULL, '', '999', NULL, '1', 'sys:operateinfo:update', 'system', now(), 'system', now(), '');
INSERT INTO `sys_menu` (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, TYPE, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS)VALUES (56, '12', '0,10,12', '删除', 3, NULL, '', '999', NULL, '1', 'sys:operateinfo:delete', 'system', now(), 'system', now(), '');
COMMIT;
