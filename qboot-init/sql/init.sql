/*
 ...
 Source Server         : macLoacl
 Source Server Type    : MySQL
 Source Server Version : 50727
 Source Host           : localhost:3606
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COMMENT='组织机构';
...
) ENGINE=InnoDB AUTO_INCREMENT=339 DEFAULT CHARSET=utf8mb4 COMMENT='菜单';
...
) ENGINE=InnoDB AUTO_INCREMENT=59314 DEFAULT CHARSET=utf8mb4 COMMENT='操作日志表.';
...
CREATE TABLE `sys_operate_log_info` (
  ...
  `URI_TYPE` int(6) DEFAULT '0' COMMENT 'URI类型.1:菜单地址，2：操作地址，0：其它;默认为0.',
  `PHYSICS_FLAG` int(6) DEFAULT '1' COMMENT '物理删除标识.1:正常;2:删除;默认值为1.',
...
) ENGINE=InnoDB AUTO_INCREMENT=172 DEFAULT CHARSET=utf8mb4 COMMENT='操作日志配置表.';

-- ----------------------------
-- Table structure for sys_param_class
-- ----------------------------
...
CREATE TABLE `sys_param_class` (
  ...
  `VISIBLE` int(4) NOT NULL DEFAULT '1' COMMENT '是否可用：1-可用；0-停用',
  `CREATE_BY` varchar(32) NOT NULL COMMENT '创建者',
  `CREATE_DATE` datetime NOT NULL COMMENT '创建时间',
  `UPDATE_BY` varchar(32) DEFAULT NULL COMMENT '更新者',
  `UPDATE_DATE` datetime DEFAULT NULL COMMENT '更新时间',
  `REMARKS` varchar(255) DEFAULT NULL COMMENT '备注信息',
  `PHYSICS_FLAG` int(11) DEFAULT '1' COMMENT '删除标识：1-正常；0-删除',
  PRIMARY KEY (`ID`) USING BTREE,
  UNIQUE KEY `PARAM_KEY` (`PARAM_TYPE_NAME`) USING BTREE,
  KEY `CREATE_BY` (`CREATE_BY`) USING BTREE,
  KEY `CREATE_DATE` (`CREATE_DATE`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=57 DEFAULT CHARSET=utf8mb4 COMMENT='系统参数';
...
) ENGINE=InnoDB AUTO_INCREMENT=164 DEFAULT CHARSET=utf8mb4 COMMENT='系统参数';

-- ----------------------------
-- Table structure for sys_project_gen
-- ----------------------------
DROP TABLE IF EXISTS `sys_project_gen`;
CREATE TABLE `sys_project_gen` (
  `ID` bigint(20) NOT NULL COMMENT '编号',
  `PROJECT_NAME` varchar(32) NOT NULL COMMENT '项目名',
  `PROJECT_TYPE` int(1) NOT NULL COMMENT '项目类型；1.web项目2.interface项目3.web+interface项目',
  `CREATE_BY` varchar(32) NOT NULL COMMENT '创建者',
  `CREATE_DATE` datetime NOT NULL COMMENT '创建时间',
  `UPDATE_BY` varchar(32) NOT NULL COMMENT '更新者',
  `UPDATE_DATE` datetime NOT NULL COMMENT '更新时间',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='项目生成';
...
CREATE TABLE `sys_task` (
  ...
  `STATUS` int(1) NOT NULL COMMENT '任务状态.0未启用;1启用',
  ...
  `EXEC_TYPE` int(1) NOT NULL DEFAULT '0' COMMENT '执行方式:0阻塞 1非阻塞.',
  PRIMARY KEY (`ID`) USING BTREE
...
CREATE TABLE `sys_task_log` (
  ...
  `EXEC_STATUS` int(1) DEFAULT NULL COMMENT '执行结果.1成功;2失败',
...
) ENGINE=InnoDB AUTO_INCREMENT=1341399 DEFAULT CHARSET=utf8 COMMENT='任务日志表.';
...
CREATE TABLE `sys_user` (
  ...
  `FLD_N1` int(9) DEFAULT NULL,
  `FLD_N2` int(9) DEFAULT NULL,
  `FLD_S1` varchar(64) DEFAULT NULL,
  `FLD_S2` varchar(64) DEFAULT NULL,
  ...
  KEY `CREATE_BY` (`CREATE_BY`) USING BTREE,
  KEY `CREATE_DATE` (`CREATE_DATE`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10009 DEFAULT CHARSET=utf8mb4 COMMENT='用户信息';
