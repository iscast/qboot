 ...
 */
public class GoogleVerifyCodeUtils {
    ...
    public static Boolean authcode(String codes, String savedSecret) {
        ...
        GoogleVerifyCodeUtils ga = new GoogleVerifyCodeUtils();
    ...
    public static String genSecret(String name) {
        String secret = GoogleVerifyCodeUtils.generateSecretKey();
        return secret;
    }
...
//        String secret = genSecret("admin");//获取key
        String secret = "VP6EP77QX47KSAE5";
