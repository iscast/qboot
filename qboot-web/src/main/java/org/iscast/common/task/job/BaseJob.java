...
public interface BaseJob {
	 ...
	 * 		另外,系统自带的传入参数有 :<br/>
	 * 			taskId 			Long	当前任务ID					{@link QConstants.TASK_MAP_PARAMS_KEY_TASKID}<br/>
	 * 			lastRunTime		Date	上一次执行成功的开始执行时间 		{@link QConstants.TASK_MAP_PARAMS_KEY_LAST_RUNTIME}<br/>
	 * 			lastResult		String	上一次执行成功的执行结果 			{@link QConstants.TASK_MAP_PARAMS_KEY_LAST_RESULT}<br/>
