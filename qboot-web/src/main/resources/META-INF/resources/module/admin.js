layui.define(['_config', 'layer'], function (exports) {
    ...
    var admin = {
        ...
        haveAuth: function(authKey){
        	var auth = JSON.parse(sessionStorage.getItem("auth"));
        	var page = location.hash.substring(2);
        	if(auth[page] && auth[page][authKey]){
        		return true;
        	}
        	return false ;
        },
    ...
    admin.events = {
        ...
        theme: function () {  // 设置主题
            admin.popupRight('pages/sys/theme.html');
        },
